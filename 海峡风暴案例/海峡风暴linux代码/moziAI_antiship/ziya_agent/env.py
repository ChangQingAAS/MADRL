...
from . import etc
import random
from MoZiAI_SDK.core.env import base_env
import numpy as np
...
class IraqEnv(base_env.BaseEnvironment):
    '''
    伊拉克想定环境类
    '''

    def __init__(self, IP, AIPort, scenario_name, simulate_compression, synchronous, duration_interval, server_plat="windows"):
        super(IraqEnv, self).__init__(IP, AIPort, server_plat, scenario_name, simulate_compression, synchronous, duration_interval)
