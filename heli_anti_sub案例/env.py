...
class Env(base_env.BaseEnvironment):
    ...
    def _get_target_guid(self):
        ...
        print("blueside.submarines is ",blueside.submarines)
    ...
    def _execute_action(self, action_value):
        ...
        for guid in airs:
            ...
            if self._check_is_find_target():
                ...
                # for debug
                print("contact_target_guid is ", contact_target_guid)
    ...
    def reset(self):
        ...
        重置
        """
        super(Env, self).reset(etc.app_mode)
