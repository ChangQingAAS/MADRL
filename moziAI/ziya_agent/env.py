...
from . import etc
import random
from mozi_ai_sdk.env.base_env import BaseEnvironment
import numpy as np
...
class EnvZiya(BaseEnvironment):
    '''
    伊拉克想定环境类
    '''

    def __init__(self, IP, AIPort, scenario_name, simulate_compression, synchronous, duration_interval, server_plat="windows"):
        super(EnvZiya, self).__init__(IP, AIPort, server_plat, scenario_name, simulate_compression, synchronous, duration_interval)

        #def __init__(self, IP, AIPort, platform, scenario_name, simulate_compression, synchronous, duration_interval):
