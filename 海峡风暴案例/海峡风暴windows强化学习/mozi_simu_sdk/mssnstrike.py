...
class CStrikeMission(CMission):
    ...
    def set_flight_size(self, flightSize):
        """
        设置打击任务编队规模
    ...
    def set_flight_size_check(self, bUseFlightSize):
        """
        ...
        时间：4/10/20
        """
        cmd = "ScenEdit_SetMission('" + self.m_Side + "', '" + self.strName + "', {strikeUseFlightSize = " + str(
