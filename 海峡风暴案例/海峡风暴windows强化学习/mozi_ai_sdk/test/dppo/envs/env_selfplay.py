...
import time
from mozi_simu_sdk.args import *
...
class Environment:
    ...
    def reset(self):
        ...
        self.redside = self.scenario.get_side_by_name('红方')
        self.blueside = self.scenario.get_side_by_name('蓝方')
        self.create_battle_zone(self.redside, '红方')
        self.create_battle_zone(self.blueside, '蓝方')
        self.scenario = self.step()
        self.redside = self.scenario.get_side_by_name('红方')
        self.blueside = self.scenario.get_side_by_name('蓝方')
        self.create_offensive_patrol_zone(self.redside, '红方')
        self.create_defensive_patrol_zone(self.redside, '红方')
        self.create_offensive_patrol_zone(self.blueside, '蓝方')
        self.create_defensive_patrol_zone(self.blueside, '蓝方')
        self.scenario = self.step()
